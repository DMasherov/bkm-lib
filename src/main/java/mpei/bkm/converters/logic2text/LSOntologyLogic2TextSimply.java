...
import mpei.bkm.converters.logic2text.expression2Text.Expr2String;
import mpei.bkm.converters.logic2text.expression2Text.Type2String;
...
public class LSOntologyLogic2TextSimply implements Converter<LSOntology, String> {
